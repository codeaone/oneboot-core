...
public class Money implements Serializable, Comparable<Money> {
    ...
    public long getAmountCent() {
        BigDecimal m =getAmount().setScale(2, DEFAULT_ROUNDING_MODE);
        return m.multiply(new BigDecimal(100)).longValue();
    }
    
    public String getAmountYuan() {
        DecimalFormat df1 = new DecimalFormat("0.00");  
        return df1.format(getAmount().setScale(2, DEFAULT_ROUNDING_MODE));  
    }
