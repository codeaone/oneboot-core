...
public class BeanUtils extends org.springframework.beans.BeanUtils {
	 ...
	 */
	public static void copyPropertiesNull(Object source, Object target, String... ignoreProperties)
			throws BeansException {
				...
				if (sourcePd != null) {
					...
					if (readMethod != null && ClassUtils.isAssignable(writeMethod.getParameterTypes()[0],
						...
						try {
							 ...
							 * writeMethod.invoke(target, value); } } else { writeMethod.invoke(target,
							 * value); }
							 */
							if (value != null) {
